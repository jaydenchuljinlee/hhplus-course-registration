...
INSERT INTO lecture (lecture_name, description, tutor_id, capacity, open_yn, created_at, updated_at, active_yn)
VALUES
    ('토비의 스프링 마스터 클래스', '스프링 프레임워크의 내부 구조와 원리를 상세히 설명하며, 실전 예제와 함께 스프링의 모든 것을 다룹니다.', 1, 50, 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    ('클린 코드 작성법', '소프트웨어 공학의 대가, 로버트 C. 마틴(밥 아저씨)이 말하는 클린 코드 작성법과 설계 원칙을 학습하는 강의입니다.', 2, 30, 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    ('소셜 미디어와 창업', '마크 주커버그의 페이스북 창업 스토리와 함께, 성공적인 스타트업을 만들기 위한 전략과 소셜 미디어의 활용 방안을 다루는 강의입니다.', 3, 100, 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y');
