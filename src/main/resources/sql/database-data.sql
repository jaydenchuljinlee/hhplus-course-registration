INSERT INTO tutor (name, description, phone_number, email, created_at, updated_at, active_yn) VALUES
...
INSERT INTO trainee (name, phone_number, email, created_at, updated_at, active_yn)
VALUES
...
INSERT INTO lecture (tutor_id, capacity, date, open_yn, created_at, updated_at, active_yn)
VALUES
    (1, 30, '2024-10-01T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    (1, 30, '2024-10-02T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    (1, 30, '2024-10-03T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),

    (2, 30, '2024-10-04T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    (2, 30, '2024-10-05T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    (2, 30, '2024-10-06T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),

    (3, 30, '2024-10-07T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    (3, 30, '2024-10-08T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y'),
    (3, 30, '2024-10-09T00:00:00', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Y');
